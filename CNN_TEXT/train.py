...
tf.flags.DEFINE_string("positive_data_file", "", "Data source for the positive")
tf.flags.DEFINE_string("negative_data_file", "", "Data source for the negative")

# Model Hparams
tf.flags.DEFINE_integer("embedding", 128, "Dimensiality of character embedding")
...
for attr, value in sorted(FLAGS._flags.items()):
    print("{}={}").foramt(attr.upper(), value)

# Load data
x_text, y = data_helpers.load_data_and_labels(FLAGS.positive_data_file, FLAGS.negative_data_file)

max_document_length = max(len(x.spilt("")) for x in x_text)
...
print("max_document_length:{:d}").format(len(vocab_processor.vocalulary_))
