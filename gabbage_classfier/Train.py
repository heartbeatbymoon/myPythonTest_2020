...
from gabbage_classfier.PreWork import get_file, get_batch
from gabbage_classfier.CNN_module import deep_CNN, losses, trainning, evaluation
...
# 获取批次batch
train_dir = 'G:/datas/gabbage/test'  # 训练样本的读入路径
logs_train_dir = 'G:/datas/gabbage'  # logs存储路径
